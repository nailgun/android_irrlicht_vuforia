...
import name.nailgun.irrlichtvuforia.R;
...
public class MainActivity extends Activity
{
    ...
    private static final String NATIVE_LIB_SAMPLE = "irrlicht_vuforia";    
    ...
    {   
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            {
                QCAR.setInitParameters(MainActivity.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(MainActivity.this).create();
